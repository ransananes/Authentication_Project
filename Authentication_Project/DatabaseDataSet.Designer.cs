...
namespace Authentication_Project {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usersRow AddusersRow(int Id, string username, string password, int blocked) {
        ...
        public partial class usersRow : global::System.Data.DataRow {
            ...
            public int blocked {
                get {
                    return ((int)(this[this.tableusers.blockedColumn]));
                }
                set {
...
namespace Authentication_Project.DatabaseDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[users] WHERE (([Id] = @Original_Id) AND ([username] = @Origina" +
                "l_username) AND ([password] = @Original_password) AND ([blocked] = @Original_blo" +
                "cked))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([Id], [username], [password], [blocked]) VALUES (@Id, " +
                "@username, @password, @blocked);\r\nSELECT Id, username, password, blocked FROM us" +
                "ers WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [Id] = @Id, [username] = @username, [password] = @password, [blocked] = @blocked WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([blocked] = @Original_blocked));
SELECT Id, username, password, blocked FROM users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Authentication_Project.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password, blocked FROM dbo.users";
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, int Original_blocked) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_blocked));
        ...
        public virtual int Insert(int Id, string username, string password, int blocked) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(blocked));
        ...
        public virtual int Update(int Id, string username, string password, int blocked, int Original_Id, string Original_username, string Original_password, int Original_blocked) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(blocked));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_blocked));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, int blocked, int Original_Id, string Original_username, string Original_password, int Original_blocked) {
            return this.Update(Original_Id, username, password, blocked, Original_Id, Original_username, Original_password, Original_blocked);
        }
    }
